...
- [13-comparisons-and-equality.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/13-comparisons-and-equality.md): So sánh, đẳng thức, Abstract Equality (==) vs Strict Equality (===), dị biệt của null/0, và Object.is().
- [13-comparisons-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/13-comparisons-demo.js): Code thực nghiệm dị biệt null & 0, so sánh từ điển Unicode của chuỗi, bẫy NaN, và Object.is().
- [14-conditionals-and-logical-branching.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/14-conditionals-and-logical-branching.md): Cấu trúc điều kiện, 8 giá trị Falsy, Strict matching trong switch, bẫy block scope {}, và Lookup Table Pattern.
- [14-conditionals-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/14-conditionals-demo.js): Code thực nghiệm kiểm chứng Falsy, switch case scope {}, intentional fallthrough, và Object Lookup.
- [15-loops-and-control-flow.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/15-loops-and-control-flow.md): Vòng lặp while vs do...while, phân biệt triệt để for...in vs for...of, Labeled Break, và cạm bẫy mutate mảng.
- [15-loops-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/15-loops-demo.js): Code thực nghiệm for...in prototype pollution, for...of, labeled statement matrix search, và duyệt ngược khi splice.
- [16-strings-and-template-literals.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/16-strings-and-template-literals.md): Tính bất biến của chuỗi, UTF-16 surrogate pairs (Emoji), phân biệt slice vs substring, và Tagged Template Literals.
- [16-strings-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/16-strings-demo.js): Code thực nghiệm string immutability, Emoji code points, replaceAll, và Tagged Template XSS Sanitizer.
- [17-numbers-bitwise-and-bigint.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/17-numbers-bitwise-and-bigint.md): IEEE 754 float precision, Number.EPSILON, bẫy MIN_VALUE > 0, thao tác bitwise 32-bit, và BigInt JSON serialization.
- [17-numbers-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/17-numbers-demo.js): Code thực nghiệm so sánh an toàn với EPSILON, parseInt radix, 32-bit bitwise truncate, và BigInt JSON serialization.
- [18-dates-and-time-deep-dive.md](file:///d:/my-project/revision-document/javascript/01-fundamentals/18-dates-and-time-deep-dive.md): Đối tượng Date, Epoch ms, cạm bẫy tháng 0-indexed, cạm bẫy Date mutability, và chuẩn định dạng Intl.DateTimeFormat.
- [18-dates-demo.js](file:///d:/my-project/revision-document/javascript/01-fundamentals/18-dates-demo.js): Code thực nghiệm Epoch ms, 0-indexed month, clone Date an toàn, và Intl.DateTimeFormat (vi-VN & en-US).
